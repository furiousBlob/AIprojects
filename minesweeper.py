...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        newsentence = Sentence(undeterminedcells, count - countundetermined)
        ...
        for sentence in self.knowledge:
            if newsentence.cells.issubset(sentence.cells) and sentence.count != 0 and newsentence.count !=0 and newsentence != sentence:
                ...
                sentencesubset = Sentence(list(subset), sentence.count - newsentence.count)
                self.knowledge.append(sentencesubset)
